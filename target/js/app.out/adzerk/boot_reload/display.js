...
var attr = cljs.core.nth.call(null,vec__7318,(0),null);
var v = cljs.core.nth.call(null,vec__7318,(1),null);
...
var args7319 = [];
var len__5964__auto___7322 = arguments.length;
var i__5965__auto___7323 = (0);
while(true){
if((i__5965__auto___7323 < len__5964__auto___7322)){
args7319.push((arguments[i__5965__auto___7323]));

var G__7324 = (i__5965__auto___7323 + (1));
i__5965__auto___7323 = G__7324;
continue;
} else {
}
break;
...
var len__5964__auto___7327 = arguments.length;
var i__5965__auto___7328 = (0);
while(true){
if((i__5965__auto___7328 < len__5964__auto___7327)){
args__5971__auto__.push((arguments[i__5965__auto___7328]));

var G__7329 = (i__5965__auto___7328 + (1));
i__5965__auto___7328 = G__7329;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7326){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7326));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7330){
var map__7334 = p__7330;
...
var data = map__7334__$1;
var message = cljs.core.get.call(null,map__7334__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7334__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7334__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7336 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__7336,goog.events.EventType.CLICK,((function (G__7336,map__7334,map__7334__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7336,map__7334,map__7334__$1,data,message,line,file))
);

return G__7336;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7337){
var map__7341 = p__7337;
var map__7341__$1 = ((((!((map__7341 == null)))?((((map__7341.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7341.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7341):map__7341);
var data = map__7341__$1;
var message = cljs.core.get.call(null,map__7341__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7341__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7341__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7343 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__7343,goog.events.EventType.CLICK,((function (G__7343,map__7341,map__7341__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7343,map__7341,map__7341__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7344){
var map__7348 = p__7344;
var map__7348__$1 = ((((!((map__7348 == null)))?((((map__7348.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7348.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7348):map__7348);
var messages = map__7348__$1;
var warnings = cljs.core.get.call(null,map__7348__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7348__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__7350 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7350,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7350,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7351){
var map__7354 = p__7351;
var map__7354__$1 = ((((!((map__7354 == null)))?((((map__7354.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7354.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7354):map__7354);
var messages = map__7354__$1;
var warnings = cljs.core.get.call(null,map__7354__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7354__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7354,map__7354__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7354,map__7354__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7354,map__7354__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7354,map__7354__$1,messages,warnings,exception))
;
...
}catch (e7357){if((e7357 instanceof Error)){
var __7358 = e7357;
} else {
throw e7357;
